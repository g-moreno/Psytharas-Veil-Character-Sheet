    ...
    const CLASSES = [
      ...
      { key:"Beast Tamer", role:"Companion Striker", startHP:12,
        weapons:[
          {name:"Tamer’s Spear", dmg:"1d8+3", type:"Melee", special:{name:"Beast Rally", text:"Companion attacks immediately."}},
      ...
      { key:"Bounty Hunter", role:"Ranged DPS", startHP:11,
        weapons:[
          ...
          {name:"Dual Blasters", dmg:"2×(1d6+3)", type:"Ranged", special:{name:"Rapid Barrage", text:"Nova fire; once/short rest (Focus to reuse)."}}
        ],
        armor:[
          {name:"Hunter’s Rig", type:"Medium", ac:14, perk:"+1 to ranged attack rolls for 1 round (1/rest)."},
      ...
      { key:"Specter", role:"Intel Specialist", startHP:11,
        weapons:[
          {name:"Scout Rifle", dmg:"1d8+3", type:"Ranged", special:{name:"Spotter’s Mark", text:"Ally crit range +1 vs target."}},
      ...
      { key:"Medic", role:"Pure Healer", startHP:10,
        weapons:[
          {name:"Medi-Pistol", dmg:"—", type:"Ranged Healer", special:{name:"Stim Shot", text:"Grant +10 ft movement."}},
      ...
      { key:"Luminar", role:"Spiritual-Tech Healer", startHP:10,
        weapons:[
          {name:"Radiant Focus", dmg:"—", type:"Healer", special:{name:"Radiant Infusion", text:"Heals; details per GM packet."}},
      ...
      { key:"Scientist", role:"Support/Utility", startHP:10,
        weapons:[
          {name:"Analyzer Drone", dmg:"—", type:"Support", special:{name:"Weakpoint Mark", text:"Allies +1d6 dmg vs target."}},
          {name:"Chem Dispenser", dmg:"—", type:"Control", special:{name:"Cloud", text:"Create smoke/acid cloud."}}
        ],
        armor:[
      ...
      { key:"Politician", role:"Social Control", startHP:10,
        weapons:[
          ...
          {name:"Diplomat’s Pistol", dmg:"1d8+3", type:"Ranged", special:{name:"Disarm Hostility", text:"One enemy can’t attack you."}}
        ],
        armor:[
      ...
      { 
    key:"Detective", role:"Versatile Investigator", startHP:12,
    weapons:[
        {name:"Service Pistol", dmg:"1d8+3", type:"Ranged", special:{name:"Mark Weakpoint", text:"After hitting, the next ally attack vs that target gains advantage (1/short rest)."}},
        {name:"Shock Baton", dmg:"1d6+3", type:"Melee", special:{name:"Stun Strike", text:"On hit, target rolls CON save (DC 12) or is stunned until end of next turn (1/short rest)."}}
        ],
    armor:[
        {name:"Trenchcoat Vest", type:"Light", ac:12, perk:"Once/short rest, blend into dim light or crowds, gaining advantage on Stealth checks for 1 minute."},
        {name:"Investigator’s Overcoat", type:"Medium", ac:13, perk:"Once/short rest, gain advantage on an Insight or Investigation check."}
        ],
    utils:["Deductive Strike (Offensive) — After observing a foe for 1 round, your next attack automatically hits and deals +1d8 bonus damage (1/short rest).", "Calculated Evasion (Defensive) — As a reaction, halve the damage of an incoming attack (1/short rest)."]
      }
    ];

    const SPECIES = [
      {key:"Human", bonuses:{any:["Any","Any"], amt:[1,1]}, naturalArmor:null, note:"Versatility — 1/long rest, advantage on any skill check."},
      {key:"Lombax", bonuses:{DEX:2, INT:1}, naturalArmor:null, note:"Tinker’s Ingenuity — 1/long rest, +2 to AC or attacks for 1 round."},
      {key:"Virellian", bonuses:{CON:2, WIS:1}, naturalArmor:null, note:"Aquatic Mastery — Swim; heal 1d6 in water (1/long rest)."},
      {key:"Drakari", bonuses:{STR:2, CON:1}, naturalArmor:{base:13, uses:"DEX"}, note:"Scaly Resilience — Natural AC 13 + Dex; 1/long rest halve incoming dmg."},
      {key:"Auralis", bonuses:{INT:2, CHA:1}, naturalArmor:null, note:"Energy Surge — 1/short rest +1d6 energy dmg on an attack."},
      {key:"Thrynn", bonuses:{DEX:2}, naturalArmor:null, note:"Skybound — Glide; 1/long rest dash w/o OAs."},
      {key:"Synthborn", bonuses:{CON:2, INT:1}, naturalArmor:null, note:"Systems Override — Auto-succeed save vs poison/disease/mind control once/long rest."},
      {key:"Myrrid", bonuses:{WIS:2, CON:1}, naturalArmor:null, note:"Regrowth — Heal level + WIS mod once/long rest."},
      {key:"Grey", bonuses:{INT:2, WIS:1}, naturalArmor:null, note:"Mind Probe — Read surface thoughts once/long rest."},
      {key:"Symbiote", bonuses:{choice2:["STR","DEX"], CON:1}, naturalArmor:null, note:"Symbiotic Surge — 1/long rest, advantage on all attack rolls for 1 round; take 1d4 damage after."}
    ];
